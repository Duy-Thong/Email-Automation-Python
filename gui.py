...
def submitfile():
    ...
    if data_path == "" or index_path == "":
        tk.messagebox.showerror(
            "Empty Fields!", "Please enter data path and index path."
        )
        return
    screen2.pack_forget()
    screen3.pack()
...
text = ctk.CTkLabel(
    master=screen1,
    text="Welcome to Email Automation by DuyThong-SoMedia",
    font=("Arial", 15),
    text_color="white",
...
login_button = ctk.CTkButton(
    master=screen1, text="Login", width=100, height=30, command=lambda: login()
)
...
back_button = ctk.CTkButton(
    master=screen2, text="Back", width=70, height=25, command=lambda: back_to_screen1()
)
back_button.pack()
...
Next_button = ctk.CTkButton(
    master=screen2, text="Next", width=100, height=30, command=lambda: submitfile()
)
Next_button.pack()
...
back_tosc2 = ctk.CTkButton(
    master=screen3, text="Back", width=70, height=30, command=lambda: back_to_screen2()
)
...
send_button = ctk.CTkButton(
    screen3, text="Send", width=100, height=30, command=lambda: send_email()
)
